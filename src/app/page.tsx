...
export default function Home() {
  return (
    <main className="relative flex flex-col min-h-screen min-w-screen justify-around p-5 lg:p-10">
      ...
      <div className="mb-8 lg:top-1 lg:left-1 lg:absolute lg:grid lg:text-center lg:pt-5 lg:max-w-3xl lg:w-[200px] lg:mb-0 lg:grid-cols-1 lg:grid-rows-4 lg:text-left">
        <a
          href="/about"
      ...
      <div className="mb-8 lg:absolute lg:top-1 lg:right-1 lg:pt-5 lg:items-center lg:justify-end lg:max-w-4xl lg:pr-10">
