  ...
  return (
    <main className="flex flex-row justify-center max-h-screen max-w-screen">
      ...
      <div className="w-full m-6">
        <p className="max-w-full text-[200%] font-bold text-center mt-[30%]">About Me!</p>
        <p className="max-w-full text-[85%] text-center mt-[13%]">Hello Everyone,</p>
        <p className="max-w-full indent-8 text-[85%] text-left mt-[5%]">
