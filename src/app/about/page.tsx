  ...
  return (
    <main className="flex flex-row justify-around h-screen max-w-screen">
      ...
      <div className="w-1/3 order-2">
        <p className="max-w-full text-[200%] text-black font-bold text-center mt-[15%]">About Me!</p>
        {/*<p className="text-[300%] font-bold text-center mt-[15%]">
          Alexander Aviles
  </p>*/}
        <p className="max-w-full text-[150%] text-black text-center mt-[13%]">Hello Everyone,</p>
